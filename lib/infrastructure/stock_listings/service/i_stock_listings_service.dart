...
abstract class IStockListingsService {
  Future<Payload<List<StockListingModel>>> getAllAvailableListings();

  Future<Payload<List<IndexModel>>> getIndices();

  Future<Payload<List<String>>> getExchanges();

  Future<Payload<ExchangeModel>> getExchange({required String exchangeSymbol});

  Future<Payload<List<StockListingModel>>> getExchangeListings({required String exchangeSymbol});
}
