...
class Exchange extends Equatable {
  ...
  final List<StockMarketHoliday> stockMarketHolidays;
...
class OpeningHours extends Equatable {
  final DateValueObject openingHour;
  final DateValueObject closingHour;
...
class _$InvalidOpeningHours extends OpeningHours {
  const _$InvalidOpeningHours()
      : super(
    openingHour: const DateValueObject.invalid(),
    closingHour: const DateValueObject.invalid(),
