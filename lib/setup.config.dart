...
import 'package:stockz/application/core/caching/caching_cubit.dart' as _i48;
...
import 'package:stockz/infrastructure/core/cache/database_definition.dart'
    as _i7;
import 'package:stockz/infrastructure/core/cache/database_module.dart' as _i53;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i40.IBalanceSheetStatementCache>(() =>
        _i41.BalanceSheetStatementCache(gh<_i39.BalanceSheetStatementDao>()));
    gh.lazySingleton<_i42.IBalanceSheetStatementRepository>(
        () => _i43.BalanceSheetStatementService(
              gh<_i13.IBalanceSheetStatementService>(),
              gh<_i40.IBalanceSheetStatementCache>(),
            ));
    gh.lazySingleton<_i44.ICacheRepository>(
        () => _i45.CacheRepository(gh<_i15.ICacheService>()));
    gh.factory<_i46.IIncomeStatementService>(
      () =>
          _i47.IncomeStatementService(gh<_i28.IncomeStatementChopperService>()),
      registerFor: {_online},
    );
    gh.factory<_i48.CachingCubit>(() => _i48.CachingCubit(
          gh<_i7.DriftDb>(),
          gh<_i44.ICacheRepository>(),
...
class _$BalanceSheetStatementServiceModule
    extends _i49.BalanceSheetStatementServiceModule {}

class _$CashFlowStatementServiceModule
    extends _i50.CashFlowStatementServiceModule {}

class _$CompanyProfileServiceModule extends _i51.CompanyProfileServiceModule {}

class _$IncomeStatementServiceModule
    extends _i52.IncomeStatementServiceModule {}
