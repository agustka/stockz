...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i31.IStockListingsService>(
      () => _i32.StockListingsService(gh<_i10.StockListingsChopperService>()),
      registerFor: {_online},
    );
    gh.lazySingleton<_i33.ICacheRepository>(
        () => _i34.CacheRepository(gh<_i17.ICacheService>()));
