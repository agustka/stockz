...
import 'package:stockz/infrastructure/chart/cache/chart_dao.dart' as _i46;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i4.EventBus>(() => eventBusModule.eventBus);
    ...
    gh.factory<_i7.ExchangeListingsChopperService>(
        () => exchangeListingsServiceModule.stockListingsChopperService);
    gh.factory<_i8.CompanyProfileChopperService>(
        () => companyProfileServiceModule.companyProfileChopperService);
    gh.factory<_i9.CashFlowStatementChopperService>(
        () => cashFlowStatementServiceModule.cashFlowStatementChopperService);
    gh.factory<_i10.BalanceSheetStatementChopperService>(() =>
    ...
    gh.factory<_i23.ICompanyProfileService>(
      () => _i24.CompanyProfileService(gh<_i8.CompanyProfileChopperService>()),
      registerFor: {_online},
    );
    ...
    gh.factory<_i31.ExchangeListingsService>(
      () => _i31.ExchangeListingsService(
          gh<_i7.ExchangeListingsChopperService>()),
      registerFor: {_online},
    );
    ...
    gh.factory<_i21.ICashFlowStatementService>(
      () => _i43.CashFlowStatementService(
          gh<_i9.CashFlowStatementChopperService>()),
      registerFor: {_online},
    );
    gh.lazySingleton<_i34.DriftDb>(
      () => _i44.OfflineDriftDb(),
    ...
    gh.factory<_i45.IncomeStatementDao>(
        () => _i45.IncomeStatementDao(gh<_i34.DriftDb>()));
    gh.factory<_i46.ChartDao>(() => _i46.ChartDao(gh<_i34.DriftDb>()));
    gh.factory<_i47.StockListingsDao>(
        () => _i47.StockListingsDao(gh<_i34.DriftDb>()));
    gh.factory<_i48.CompanyProfileDao>(
        () => _i48.CompanyProfileDao(gh<_i34.DriftDb>()));
    gh.factory<_i49.CashFlowStatementDao>(
        () => _i49.CashFlowStatementDao(gh<_i34.DriftDb>()));
    gh.factory<_i50.BalanceSheetStatementDao>(
        () => _i50.BalanceSheetStatementDao(gh<_i34.DriftDb>()));
    gh.factory<_i37.IChartService>(
    ...
    gh.factory<_i52.ICashFlowStatementCache>(
        () => _i53.CashFlowStatementCache(gh<_i49.CashFlowStatementDao>()));
    ...
    gh.factory<_i19.IIncomeStatementService>(
      () =>
          _i62.IncomeStatementService(gh<_i5.IncomeStatementChopperService>()),
      registerFor: {_online},
    );
    gh.lazySingleton<_i17.ICacheService>(
      () => _i63.CacheService(),
    ...
    gh.factory<_i64.IBalanceSheetStatementCache>(() =>
        _i65.BalanceSheetStatementCache(gh<_i50.BalanceSheetStatementDao>()));
    gh.factory<_i27.IBalanceSheetStatementService>(
      () => _i66.BalanceSheetStatementService(
          gh<_i10.BalanceSheetStatementChopperService>()),
      registerFor: {_online},
    );
    gh.factory<_i67.ExchangeListingsCache>(
        () => _i67.ExchangeListingsCache(gh<_i47.StockListingsDao>()));
    gh.factory<_i68.IChartCache>(() => _i69.ChartCache(gh<_i46.ChartDao>()));
    ...
    gh.factory<_i71.IIncomeStatementCache>(
        () => _i72.IncomeStatementCache(gh<_i45.IncomeStatementDao>()));
...
class _$EventBusModule extends _i86.EventBusModule {}
